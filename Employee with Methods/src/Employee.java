...
public class Employee {
	...
	void setDetails(String name, String email, String empid, float bsal)
	{
		this.name = name;
		this.emailid = email;
		this.empid = empid;
	...
	public static void main(String[] args) {
		...
		e1.setDetails("Alpha","alpha@gmail.com","a121",25436.78f);
		e1.getDetails();
		Employee e2 = new Employee();
		
		e2.setDetails("Beta","beta@gmail.com","A122",36415.42f);
		e2.getDetails();
	}
}
